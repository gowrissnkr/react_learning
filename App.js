    ...
    return (
        <nav id="main-nav" className="tranformClass">
            ...
            <div className="right-menu">
                <img src="https://cdn4.vectorstock.com/i/1000x1000/71/93/black-shopping-cart-icon-on-transparent-background-vector-31557193.jpg" />
            </div>
        </nav>
    )
}
...
const ResCard = (props) => {
    const { cloudinaryImageId, name, avgRating, cuisines, costForTwo } = props.resList.data
    return (
        <>
...
const Body = () => {
    return (
        <div>
            <div className="mid-menu" style={{ marginTop: "100px" }}>
                <input type="text" placeholder="Search..." />
            </div>
            <section id="res-section">
                <div className="res-grid">
                    {restaurantList.map((resList) => (
                        <ResCard key={resList.data.uuid} resList={resList} />
                    ))}
                </div>
            </section>
        </div>
